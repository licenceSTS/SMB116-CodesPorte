...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gareAdapter.setOnItemClickListener(position -> {
            Intent intent = new Intent(MainActivity.this, ListeCodeActivity.class);
    ...
    private void initGareList() {
        ...
        List<CodeItem> codesGareDeLyon = new ArrayList<>();
        codesGareDeLyon.add(new CodeItem("Porte A", "CodeA", 2.374, 48.844)); // Exemple de données
        codesGareDeLyon.add(new CodeItem("Porte B", "CodeB", 2.375, 48.845));

        List<CodeItem> codesGareDuNord = new ArrayList<>();
        codesGareDuNord.add(new CodeItem("Porte C", "CodeC", 2.356, 48.876));
        codesGareDuNord.add(new CodeItem("Porte D", "CodeD", 2.357, 48.877));
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.isEmpty()) {
                    ...
                    List<GareItem> filtered = gareList.stream()
                            .filter(gare -> gare.getName().toLowerCase().contains(newText.toLowerCase()))
